	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Book</a>
				  ...
				  <div class="card-body">
					...
					<div class="tab-content">
							...
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemDetailsItemNumber">Book Number<span class="requiredIcon">*</span></label>
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsProductID">Book ID</label>
							  ...
							  <div class="form-row">
								  <div class="form-group col-md-6">
									<label for="itemDetailsItemName">Book Name<span class="requiredIcon">*</span></label>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-6" style="display:inline-block">
								  ...
								  <label for="itemDetailsDescription">Author</label>
								  <input rows="4" class="form-control" name="itemDetailsDescription" id="itemDetailsDescription">
								</div>
							  </div>
							  <div class="form-row">
								<div hidden class="form-group col-md-3">
								  <label for="itemDetailsDiscount">Discount %</label>
								  <input type="text" class="form-control" value="10" name="itemDetailsDiscount" id="itemDetailsDiscount">
								</div>
								<div class="form-group col-md-3">
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<p>You can upload an image for a particular book.</p> 
							<p>Please make sure the book is already added to database before uploading the image.</p>
							<br>							
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Book</a>
						</li>
